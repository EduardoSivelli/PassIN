...
export default function Ticket(){
  ...
  return(
    ...
    <View className="flex-1 bg-green-500">
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="-mt-28 -z-10" contentContainerClassName="px-8 pb-8">
        <Credential 
      ...
      <Modal visible={expandQRCode} statusBarTranslucent animationType="slide">
        <View className="flex-1 bg-green-500 items-center justify-center">
          <TouchableOpacity activeOpacity={0.7} onPress={() => setExpandQRCode(false)}>
            ...
            <Text className="font-body text-orange-500 text-sm text-center mt-11">Fechar QRCode</Text>
          </TouchableOpacity>
        </View>
      </Modal>
    </View>
